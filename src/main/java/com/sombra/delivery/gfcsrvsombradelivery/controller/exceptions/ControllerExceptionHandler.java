...
import com.sombra.delivery.gfcsrvsombradelivery.exceptions.ObjctNotFoundException;

@ControllerAdvice
public class ControllerExceptionHandler {
    
    @ExceptionHandler(ObjctNotFoundException.class)
    public ResponseEntity<StandardError> ObjctNotFoundException(ObjctNotFoundException e){
